...
r.post('/:id/images', auth, requirePermission('media.write'), upload.array('images', 4), persistValidatedImages, c.addImages);
r.put('/:id/images/:imageId/primary', auth, requirePermission('media.write'), c.setPrimaryImage);
